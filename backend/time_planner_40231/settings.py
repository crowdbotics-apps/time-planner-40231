"""
Django settings for time_planner_40231 project.
...
ROOT_URLCONF = 'time_planner_40231.urls'
...
WSGI_APPLICATION = 'time_planner_40231.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "time_planner_40231 API",
    "DESCRIPTION": "API documentation for time_planner_40231 App",
    "VERSION": "v1",
}
